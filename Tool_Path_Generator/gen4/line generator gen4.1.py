...
# Function to move points by the average normal direction
def move_points_by_normal(points, region_size, distance):
...
def start_processing():
    ...
    while z_height_count < anomaly_height:
        ...
        moved_points = move_points_by_normal(points, region_size, move_distance)
...
label_stepover.grid(row=13, column=0, padx=10, pady=5, sticky=tk.W)

label_stepover_value = tk.Label(root, text="0.00")
label_stepover_value.grid(row=13, column=1, padx=10, pady=5, sticky=tk.W)

# Tolerance Display
label_tolerance = tk.Label(root, text="Tolerance (in):")
label_tolerance.grid(row=14, column=0, padx=10, pady=5, sticky=tk.W)

label_tolerance_value = tk.Label(root, text="0.00")
label_tolerance_value.grid(row=14, column=1, padx=10, pady=5, sticky=tk.W)

button_start = tk.Button(root, text="Start", command=start_processing)
button_start.grid(row=15, column=0, columnspan=3, padx=10, pady=10)
