...
def start_processing():
    ...
    # Extract and average lines parallel to the y-axis (stepover x)
    stepover_lines, initial_stepover_lines = extract_lines(points, stepover, tolerance, axis='x', initial_stepover=initial_stepover)
...
label_surface_res.grid(row=5, column=0, padx=10, pady=5, sticky=tk.W)
...
surface_res_menu.grid(row=5, column=1, padx=10, pady=5)

spin_surface_res = tk.Spinbox(root, from_=0.0, to=100.0, increment=1.0, state="disabled")
spin_surface_res.grid(row=5, column=2, padx=10, pady=5)
label_surface_res_percent = tk.Label(root, text="% of chord length")
label_surface_res_percent.grid(row=5, column=3, padx=10, pady=5, sticky=tk.W)
...
label_tolerance_res.grid(row=6, column=0, padx=10, pady=5, sticky=tk.W)
...
tolerance_res_menu.grid(row=6, column=1, padx=10, pady=5)

spin_tolerance_res = tk.Spinbox(root, from_=0.0, to=10.0, increment=0.1, state="disabled")
spin_tolerance_res.grid(row=6, column=2, padx=10, pady=5)
label_tolerance_in = tk.Label(root, text="(in)")
label_tolerance_in.grid(row=6, column=3, padx=10, pady=5, sticky=tk.W)
...
cross_cut_checkbox.grid(row=7, column=0, columnspan=2, padx=10, pady=5, sticky=tk.W)
...
show_original_checkbox.grid(row=8, column=0, columnspan=2, padx=10, pady=5, sticky=tk.W)

# Maximum Grind Width Display
label_max_grind_width = tk.Label(root, text="Maximum Grind Width (in):")
label_max_grind_width.grid(row=9, column=0, padx=10, pady=5, sticky=tk.W)

label_max_grind_width_value = tk.Label(root, text="0.00")
label_max_grind_width_value.grid(row=9, column=1, padx=10, pady=5, sticky=tk.W)

# Stepover Display
label_stepover = tk.Label(root, text="Stepover (in):")
label_stepover.grid(row=10, column=0, padx=10, pady=5, sticky=tk.W)

label_stepover_value = tk.Label(root, text="0.00")
label_stepover_value.grid(row=10, column=1, padx=10, pady=5, sticky=tk.W)

# Tolerance Display
label_tolerance = tk.Label(root, text="Tolerance (in):")
label_tolerance.grid(row=11, column=0, padx=10, pady=5, sticky=tk.W)

label_tolerance_value = tk.Label(root, text="0.00")
label_tolerance_value.grid(row=11, column=1, padx=10, pady=5, sticky=tk.W)

button_start = tk.Button(root, text="Start", command=start_processing)
button_start.grid(row=12, column=0, columnspan=3, padx=10, pady=10)
